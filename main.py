...
def testModel():
    ...
    visualizeReconstructedImages(X_train[:16],X_test[:16], autoencoder, save=True)
    ...
    #visualizeInterpolation(X_test[randint(0,X_test.shape[0])], X_test[randint(0,X_test.shape[0])], encoder, decoder, save=True, nbSteps=5)
